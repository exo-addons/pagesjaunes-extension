...
public class SearchManagement implements ResourceContainer {
	...
	private static final String CATEGORY_OWNER = "pagesjaunes.category.owner";
	private static final String CATEGORY_DESCRIPTION = "pagesjaunes.category.description";
	private static final String COMPANY_ADDRESS = "companyAddress";
	private static final String ENTREPRISE_ADDRESS = "pagesjaunes.entreprise.address";
	private static final String FORUM_ID = "pagesjaunes.forum.id";
	private static final String FORUM_NAME = "pagesjaunes.forum.name";
	private static final String FORUM_OWNER = "pagesjaunes.forum.owner";
	private static final String FORUM_DESCRIPTION = "pagesjaunes.forum.description";
